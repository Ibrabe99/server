        ...
        <section class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex flex-row-reverse" style="" dir="rtl ">
                        <a href="{{route('admin.subcategories.create')}}" class="btn btn-primary mb-4" style="height: 40px;">
                            <i class="fa-solid fa-plus mr-2"></i>إضافة قسم فرعي جديد
                        </a>
                </div>
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">جدول الأقسام الفرعية</h3>
                    ...
                    <div class="card-body table-responsive " >
                      <table id="example" class="table table-bordered  table-hover  table-striped display nowrap" aria-describedby="example1_info" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <div class="ml-3">
                                    <a href="{{route('admin.subcategories.edit',$category -> id)}}" class="btn  btn-primary">
                                        <i class="fas fa-edit"></i> تعديل
                                    </a>


                                    <a href="{{ route('admin.subcategories.delete', $category->id) }}" class="btn btn-delete bg-danger ml-2">
